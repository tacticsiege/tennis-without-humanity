...
def demo_saved_agent_cont(env, agent_name, n_episodes=3, train_mode=False):
    ...
    agent = DDPG_Agent(state_size, action_size, brain_name, seed=0, params=params)
    ...
    demo_agent_cont(env, agent, num_agents, 
        n_episodes=n_episodes, train_mode=train_mode)

def demo_agent_cont(env, agent, num_agents, n_episodes=3, train_mode=False):
